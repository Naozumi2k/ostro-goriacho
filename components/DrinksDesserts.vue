...
<script>
import Drink from '@/assets/svg/drink.svg?inline'
import IceCream from '@/assets/svg/icecream.svg?inline'
import Cocktail from '@/assets/svg/cocktail.svg?inline'
